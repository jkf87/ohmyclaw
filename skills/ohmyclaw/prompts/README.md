...
|--------|----------|-----------------|---------------|-------------|
| `executor.md` | `$ohmyclaw exec`, `$ohmyclaw ralph` (executor 단계) | `auto` | glm-5 / glm-5.1 | gpt-5.6-sol |
| `planner.md` | `$ohmyclaw plan`, `$ohmyclaw deep-interview` | `reasoning` | glm-5.1 | gpt-5.6-terra |
| `architect.md` | `$ohmyclaw plan --consensus` 의 architect 단계 | `coding_arch` | glm-5.1 | **gpt-5.6-sol** |
| `reviewer.md` | `$ohmyclaw review`, `$ohmyclaw ralph` 의 검증 단계 | `reasoning` | glm-5.1 | gpt-5.6-terra |
| `verifier.md` | `$ohmyclaw verify`, `$ohmyclaw ralph` | `reasoning` | glm-5.1 | gpt-5.6-terra |
| `debugger.md` | `$ohmyclaw debug` | `debugging` | glm-5 | **gpt-5.6-sol** (HIGH) |
| `critic.md` | `$ohmyclaw plan --consensus` 의 critic 단계 | `reasoning` | glm-5.1 | gpt-5.6-terra |
| `team-orchestrator.md` | `$ohmyclaw team N:role` 의 리더 | `reasoning` | glm-5.1 | gpt-5.6-terra |
| `team-executor.md` | `$ohmyclaw team N:executor` 의 워커 | `auto` | glm-5 / glm-5.1 | gpt-5.6-sol |
